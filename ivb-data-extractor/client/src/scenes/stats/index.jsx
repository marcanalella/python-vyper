...
const Stats = () => {
    ...
    /*const fetchData = async () => {
        try {
            const response = await fetch(environment.baseUrl + `/report/${selectedAccount.id}`, {
                method: 'GET',
                headers: {
                    'Authorization': localStorage.getItem("accessToken")
                },
    ...
    return (
        <Box m="1.5rem 2.5rem">
            <FlexBetween>
                <Header title="IVB Stats" subtitle="Reports of IVB"/>
                <Box>
                    <Button
                        sx={{
                            ...
                            <Stack
                                ...
                                >
                                    {accounts && accounts.length > 0 ?
                                        accounts.map(a =>
                                            <MenuItem value={a}>{a.accountNumber}</MenuItem>
                                        ) : (
